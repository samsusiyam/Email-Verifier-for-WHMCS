...
namespace EmailVerifier\License;
...
class LicenseManager
{
    ...
    // 2. ELMS Product Key
    public const DEFAULT_PRODUCT_KEY = 'EMAIL-VERIFIER';

    // 3. WHMCS Addon Directory Name
    public const MODULE_NAME         = 'email_verifier';

    // 4. Offline cache validity (15 minutes = 900 seconds)
    ...
    /**
     * Gatekeeper check: returns true if module has an active license
     */
    ...
    /**
     * Detect domain name (Clean Domain)
     */
    ...
    /**
     * Send verification request to Host Nibo ELMS License Server
     */
    ...
    /**
     * Get detailed license info for admin UI
     */
    public function getDetails(bool $refreshLive = false): array
    {
        ...
        if (!empty($key)) {
            ...
            if (!empty($check['status'])) {
                ...
                $details['product_name'] = $check['data']['product_name'] ?? ($check['data']['product'] ?? 'Email Verifier');
